...
python main.py --left_imgs Tau_left_images/dn700 --right_imgs Tau_right_images/right_images_filtered/dn700 --disp_imgs Tau_left_images/original_depth --disp_R_imgs Tau_right_images/original_depth --savemodel checkpoints_filtered_predict_depth_dn700_300_to_600 --cont --epochs 300 --loadmodel checkpoints_filtered_predict_depth_dn700/checkpoint_300.tar
